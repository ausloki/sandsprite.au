...
- `assets/gallery/` — 7 real photos from the kennel's Facebook page (sourced via the connected Chrome extension, matched against a metadata file the owner supplied with post dates/captions), resized and compressed for web. Used on `litters.html` (the 3 June 2025 litter photos).
