...
- `assets/facilities/` — real photos of the property (kitchenette, daycare play yard, outdoor runs), shown via `data/facilities.csv` on the "Our facilities" section of `services.html`; click a category to browse all its photos in a lightbox.
